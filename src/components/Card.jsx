export default function Card(){
    return(
        <div className=""><h1 className="mx-[518px]">Card Example</h1>
        <div className="flex items-center justify-center pb-6">
           
            <div className="w-80 p-6 border border-gray-200 rounded shadow bg-white content-center">
                
            <div className="flex p-1 w-10 h-10 items-center justify-center rounded-full bg-red-600 ">
                  <svg width="22" height="16" viewBox="0 0 22 16" fill="bg-black" xmlns="http://www.w3.org/2000/svg">
            ...
            <h5 className="mb-2 text-3xl font-bold text-black ">$3.456K</h5>
